export type RiderStatus = "pending" | "under_review" | "approved" | "rejected" | "suspended" | "inactive";
export type VehicleType = "bicycle" | "motorcycle" | "scooter" | "car" | "van" | "walk";
export type RiderDocumentType = "driving_license" | "aadhaar" | "pan" | "vehicle_rc" | "insurance" | "identity" | "address_proof" | "other";
export type RiderDocumentStatus = "pending" | "verified" | "rejected" | "expired";
export type AvailabilityStatus = "online" | "offline" | "busy";
export type DeliveryTaskStatus = "assigned" | "accepted" | "picked" | "in_transit" | "delivered" | "cancelled";
